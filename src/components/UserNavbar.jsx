...
import { Layers3, Menu, ShieldCheck, X } from "lucide-react";
...
export default function Navbar({
  ...
  return (
    <nav
      className={`${
        absolute ? "position-absolute" : "position-sticky"
      ...
      <div className="container-xl">
        ...
        >
          ...
          >
            ...
            >
              Space
              <span className="custom-navbar-accent">.</span>
            </span>
          </Link>
            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  className="btn btn-sm rounded-pill fw-semibold px-4 custom-navbar-login"
                >
                  Logout
                </button>
                ...
                {user?.role === "admin" && (
                  <Link
                    to="/admin"
                    className={`btn btn-sm rounded-pill fw-medium px-4
                    d-inline-flex align-items-center gap-2
                    custom-navbar-admin
                    ${
                      isLight
                        ? "custom-navbar-admin-light"
                        : "text-white"
                    }`}
                  >
                    <ShieldCheck size={15} />
        ...
        {mobileOpen && (
          ...
          >
            ...
            <div className="d-flex flex-column gap-2 mt-3">
              {user ? (
                <>
                  <div className="text-white text-center small fw-semibold">
                    👋 {user.name}
                  </div>
