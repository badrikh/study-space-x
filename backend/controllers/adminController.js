    ...
    try {
        const bookings = await Booking.findAll({
            include: [
                ...
                { model: Seat, attributes: ['name_of_room'] },
...
export const createMenuItem = async (req, res) => {
    try {
        const { name, price, itemNumber, description, category, imageUrl, isAvailable } = req.body;
        const item = await Menu.create({ name, price, itemNumber, description, category, imageUrl, isAvailable });
...
export const updateMenuItem = async (req, res) => {
    try {
        ...
        await item.update({ name, price, itemNumber, description, category, imageUrl, isAvailable });
