...
export default function OrderSidebar({ items, onUpdateQty, onPlaceOrder, placingOrder = false }) {
      ...
      <div className="card-body">
        ...
        {items.length === 0 ? (
          <div className="text-center py-4 text-muted">
            <div style={{ fontSize: "2rem" }} className="mb-2">Cart</div>
                ...
                <div key={item.name} className="d-flex justify-content-between align-items-center small mb-2">
                  <div className="d-flex align-items-center gap-2">
                    <div className="d-flex align-items-center border rounded">
                      <button type="button" onClick={() => onUpdateQty(item.name, -1)} className="qty-btn">-</button>
